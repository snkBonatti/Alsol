...
public class SendEmail implements ScheduledAction {
	...
	public void onTime(ScheduledActionContext arg0) {
		...
		JdbcWrapper jdbc = EntityFacadeFactory.getDWFFacade().getJdbcWrapper();//JapeFactory.getEntityFacade().getJdbcWrapper();
		...
		try {
			...
			while (rs.next()) {
				...
				fatura = JasperExportManager.exportReportToPdf(jasperPrint);
				...
				try {
					...
					cfg.setGerarNumeroBoleto(false);
					...
					boletoHelper.gerarBoleto(cfg, false, false);
				...
				if (nossoNumero.equals("N")) {
					...
					corpoemail = "<html> " + 
							...
							"<body> " +
							"  <p> Prezado Cliente, <b> " + razaoSocial + " </b></p> " + 
							"  <p>Encaminhamos em anexo fatura de locação. </p> " + 
							"  <p>Qualquer dúvida entre em contato com a nossa equipe de pós-venda pelos números (34) 2512-8820 / (34) 99838-8044.</p> " + 
							"  <p>Estamos à disposição.</p> <br> " + 
							"  <p style=\"margin: 3px 0px 3px 0px;\"><b><span " + 
							"        style=\"font-size:14.0pt;font-family:&quot;Trebuchet MS&quot;,sans-serif;color:gray\">Depto Cobran&ccedil;a</span></b><span " + 
							"      style=\"font-size:14.0pt;font-family:&quot;Trebuchet MS&quot;,sans-serif;color:gray\"></span></p> " + 
							"  <p style=\"margin: 3px 0px 3px 0px;\"><span style=\"font-size:10.0pt;font-family:&quot;Trebuchet MS&quot;,sans-serif;color:gray\">34 2512-8813</p> " + 
				...
				for (String email : arrayEmail) {
					...
					//	if (impFat.equals("S")) {
						...
						entityVO = dwfFacade.getDefaultValueObjectInstance("AnexoMensagem");
						dynamicVO = (DynamicVO) entityVO;
						dynamicVO.setProperty("NOMEARQUIVO", "Fatura_Alsol.pdf");
						dynamicVO.setProperty("TIPO", "application/pdf");
							...
							if (arquivos != null) {
								for (File arquivo : arquivos) {
									...
									if (arquivo.getName().equals(cnpj + ".pdf")) {
										...
										String nomePDF = "Consumo.pdf";
										
										if (nossoNumero.equals("N")) {
											
											nomePDF = "FaturaAlsol.pdf";
										...
										entityVO = dwfFacade.getDefaultValueObjectInstance("AnexoMensagem");
										dynamicVO = (DynamicVO) entityVO;
										dynamicVO.setProperty("NOMEARQUIVO", nomePDF);
										dynamicVO.setProperty("TIPO", "application/pdf");
